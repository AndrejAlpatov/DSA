...
class QueryMenuWithAddativesIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if slot_value_date is not None:
            ...
            speech_text = output_for_query_menu_with_additives_intent (date_as_string, slot_value_for_additives, slot_value_with_or_without)
            ...
            # text for output according date and number of menu
            speech_text = output_for_query_menu_with_additives_intent(date_of_slot_value, slot_value_for_additives, slot_value_with_or_without)
            ...
            # text for output according date and number of menu
            speech_text = output_for_query_menu_with_additives_intent(date_for_output, slot_value_for_additives, slot_value_with_or_without)
